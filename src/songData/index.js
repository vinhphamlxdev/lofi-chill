...
import chill6 from "~/assets/songs/chill6.mp3";
import chill7 from "~/assets/songs/chill7.mp3";
...
import rap5 from "~/assets/songs/rap5.mp3";
import rap6 from "~/assets/songs/rap6.mp3";
import rap7 from "~/assets/songs/rap7.mp3";
import sleep1 from "~/assets/songs/sleep.mp3";
export const chill = [
  {
    id: 1,
...
export const rap = [
  {
    id: 1,
    name: "Không Phải Tại Nó - Mai Ngô",
    src: rap1,
  },
  {
    id: 2,
  ...
  {
    id: 5,
    name: "Đen ft. MIN - Bài Này Chill Phết",
    src: rap5,
  },
  {
    id: 6,
    name: "HIEUTHUHAI - CHƠI (RMX) Ft.MANBO",
    src: rap6,
  },
  {
    id: 7,
